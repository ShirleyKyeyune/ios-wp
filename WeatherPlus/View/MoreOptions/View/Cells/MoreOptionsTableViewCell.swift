...
class MoreOptionsTableViewCell: UITableViewCell {
    ...
    var degreeLabel: UILabel = {
        let label = UILabel()
        label.font = UIFont.systemFont(ofSize: WPSize.pt32, weight: .semibold)
    ...
    var timeLabel: UILabel = {
        let label = UILabel()
        label.font = UIFont.systemFont(ofSize: WPSize.pt12, weight: .regular)
        label.translatesAutoresizingMaskIntoConstraints = false
        return label
    }()
    ...
    var cityNameLabel: UILabel = {
        let label = UILabel()
        label.font = UIFont.systemFont(ofSize: WPSize.pt24, weight: .regular)
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        accessibilityIdentifier = WPConstants.AccessabilityIdentifier.MoreOptionsTableViewCell
        selectionStyle = .none
    ...
    private func setUpConstraints() {
        ...
        let weatherBackgroundViewBottomConstraint = weatherBackgroundView.bottomAnchor.constraint(equalTo: bottomAnchor, constant: -WPSize.pt4)
        ...
        // Condition image
        conditionImage.heightAnchor.constraint(greaterThanOrEqualToConstant: WPSize.pt40).isActive = true
        conditionImage.widthAnchor.constraint(greaterThanOrEqualToConstant: WPSize.pt40).isActive = true
        
        // Degree label
        let degreeLabelConstraint = degreeLabel.widthAnchor.constraint(greaterThanOrEqualToConstant: WPSize.pt92)
        degreeLabelConstraint.isActive = true
        
        // MainStackView
        mainStackView.topAnchor.constraint(equalTo: weatherBackgroundView.topAnchor, constant: WPSize.pt12).isActive = true
        mainStackView.bottomAnchor.constraint(equalTo: weatherBackgroundView.bottomAnchor, constant: -WPSize.pt12).isActive = true
        mainStackView.leadingAnchor.constraint(equalTo: weatherBackgroundView.leadingAnchor, constant: WPSize.pt20).isActive = true
        mainStackView.trailingAnchor.constraint(equalTo: weatherBackgroundView.trailingAnchor, constant: -WPSize.pt20).isActive = true
    }
