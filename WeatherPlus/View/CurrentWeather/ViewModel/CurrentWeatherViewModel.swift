...
class CurrentWeatherViewModel: CurrentWeatherViewType {
    ...
    func handleFetchWeather() {
        if let currentWeather = currentWeather {
            let newCity = WeatherRequest(cityName: currentWeather.cityName,
    ...
    private func handleFetchCurrentCityName(newLocation: Location) {
        ...
        locationService.fetchCurrentCityName(by: newLocation).sink { [weak self] completion in
            ...
            let newCity = WeatherRequest(cityName: cityName,
    ...
    var weatherStyle: WeatherStyle {
        guard let style = weatherConditionStyle else {
            return WeatherStyle(backgroundImage: WPConstants.ImageName.sunnyBackground,
