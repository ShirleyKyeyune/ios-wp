...
struct ColorThemeModel {
    ...
    var moreOptions: MainMenuColorThemeModel {
        ...
        let cellsMenu = CellsColorThemeModel(isShadowVisible: mainMenu.cells.isShadowVisible,
                                             ...
                                             clearSky: convertToColorThemeModel(mainMenu.cells.clearSky),
                                             fewClouds: convertToColorThemeModel(mainMenu.cells.fewClouds),
                                             scatteredClouds: convertToColorThemeModel(mainMenu.cells.scatteredClouds),
                                             brokenClouds: convertToColorThemeModel(mainMenu.cells.brokenClouds),
                                             showerRain: convertToColorThemeModel(mainMenu.cells.showerRain),
    ...
    init() {
        ...
        let defaultCells = Cells(isShadowVisible: true,
                                 ...
                                 clearSky: defaultColors,
                                 fewClouds: defaultColors,
                                 scatteredClouds: defaultColors,
                                 brokenClouds: defaultColors,
                                 showerRain: defaultColors,
                                 rain: defaultColors,
